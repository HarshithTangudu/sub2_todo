...
public class ToDoDAOImpl implements ToDoDAOIntf {
    ...
    private static PreparedStatement pstmt1, pstmt2, pstmt3, pstmt4, pstmt5;

    // To make DAOImpl singleton, declare the constructor as private
    // Write one factory method that returns singleton instance of the same class
    private ToDoDAOImpl() {
        try {
            con = DBConn.con();
    ...
    private static ToDoDAOIntf dao = null;
